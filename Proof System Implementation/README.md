...
- $\text{\textbf{input}: } (g,h, D, C_L, C_R,y \in \mathbb{G},\bar{\mathbf{y}}, \mathbf{C}, \bar{\mathbf{C}} \in \mathbb{G}^{m-1}, \mathbf{g}, \mathbf{h} \in \mathbb{G}^{m \cdot n} ,m,n\in \mathbb{N};\, \mathbf{a} \in \mathbb{Z}_p^{m-1},\, r,sk,b' \in \mathbb{Z}_p): \forall a_i \in (a_1, \dots, a_{m-1}) \; a_i \in [0,2^n - 1]  \wedge b' \in [0,2^n - 1] \wedge y = sk \cdot g \wedge C_L - \sum_{i=1}^{m-1}C_i = b' \cdot g + sk \cdot (C_R- \sum_{i=1}^{m-1}D) \wedge (C_{i}=a_{i} \cdot g + r \cdot y \wedge \bar{C}_{i}=a_{i} \cdot g + {r} \cdot \bar{y}_{i} \wedge D=r \cdot g)^{m-1}_{i=1}$
  - $\mathcal{P}\text{'s input}: (g,h,\mathbf{g}, \mathbf{h},m,n,\mathbf{a}, b',sk,r,D, C_R,y,\bar{\mathbf{y}})$
  - $\mathcal{V}\text{'s input}: (g,h,\mathbf{g}, \mathbf{h},m,n,D,C_L, C_R,y,\bar{\mathbf{y}}, \mathbf{C}, \bar{\mathbf{C}})$
- $\text{\textbf{output}: } \{\mathcal{V} \text{ accepts or } \mathcal{V} \text{ rejects} \}$
...
- $\text{\textbf{input}: } (g,h \in \mathbb{G}, \mathbf{g}, \mathbf{h} \in \mathbb{G}^{m \cdot n} ,m,n\in \mathbb{N};\, \mathbf{a} \in \mathbb{Z}_p^{m-1},\, b' \in \mathbb{Z}_p): \forall a_i \in (a_1, \dots, a_{m-1}) \; a_i \in [0,2^n - 1]  \wedge b' \in [0,2^n - 1]$
  - $\mathcal{P}\text{'s input}: (g,h,\mathbf{g}, \mathbf{h},m,n,\mathbf{a}, b')$
  - $\mathcal{V}\text{'s input}: (g,h,\mathbf{g}, \mathbf{h},m,n)$
- $\text{\textbf{output}: } \{\mathcal{V} \text{ accepts or } \mathcal{V} \text{ rejects} \}$
```rust
use ark_bn254::{Fr as ScalarField, G1Affine as G1Point};
...
- $\text{\textbf{input}: } (g, y \in \mathbb{G}; sk \in \mathbb{Z}_p) : y = sk \cdot g$ 
    - $\mathcal{P}\text{'s input}: (g,sk)$
    - $\mathcal{V}\text{'s input}: (g,y)$
- $\text{\textbf{output}: } \{\mathcal{V} \text{ accepts or } \mathcal{V} \text{ rejects} \}$
...
- $\text{\textbf{input}: } (g, D \in \mathbb{G}; r \in \mathbb{Z}_p): D = r \cdot g$ 
    - $\mathcal{P}\text{'s input}: (g,r)$
    - $\mathcal{V}\text{'s input}: (g,D)$
- $\text{\textbf{output}: } \{\mathcal{V} \text{ accepts or } \mathcal{V} \text{ rejects} \}$
...
```
### $\Sigma$-protocol `ab`
- $\text{\textbf{input}: } (g, D, C_L, C_R \in \mathbb{G}, \, \mathbf{C} \in \mathbb{G}^{m-1},m\in \mathbb{N};\,  sk, b' \in \mathbb{Z}_p, \mathbf{a} \in \mathbb{Z}_p^{m-1}): C_L - \sum_{i=1}^{m-1}C_i = b' \cdot g + sk \cdot (C_R- \sum_{i=1}^{m-1}D)$
  - $\mathcal{P}\text{'s input}: (g,D, C_R,m, sk, \mathbf{a}, b')$
  - $\mathcal{V}\text{'s input}: (g,D, C_L, C_R,\mathbf{C},m)$
- $\text{\textbf{output}: } \{\mathcal{V} \text{ accepts or } \mathcal{V} \text{ rejects} \}$
...
```
### $\Sigma$-protocol `y`
- $\text{\textbf{input}: } (y \in \mathbb{G}, \,\bar{\mathbf{y}}, \mathbf{C}, \bar{\mathbf{C}} \in \mathbb{G}^{m-1},m\in \mathbb{N};\,  r \in \mathbb{Z}_p): (C_{i}=a_{i} \cdot g + r \cdot y \wedge \bar{C}_{i}=a_{i} \cdot g + {r} \cdot \bar{y}_{i} \wedge D=r \cdot g)^{m-1}_{i=1}$
  - $\mathcal{P}\text{'s input}: (y,\bar{\mathbf{y}},m,r)$
  - $\mathcal{V}\text{'s input}: (y,\bar{\mathbf{y}},\mathbf{C}, \bar{\mathbf{C}},m)$
- $\text{\textbf{output}: } \{\mathcal{V} \text{ accepts or } \mathcal{V} \text{ rejects} \}$
